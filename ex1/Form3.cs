...
namespace ex1
{
    public partial class Form3 : Form
    {
        ...
        private void showitem()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from item where itemID in (SELECT  top 3 itemId FROM order_Detail GROUP BY itemId HAVING COUNT(itemId) > 0 ORDER BY COUNT(itemId) desc )", conn);
