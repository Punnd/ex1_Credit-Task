...
namespace ex1
{
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "delete from item where itemID ='" + txtidsp.Text + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if(dk == 1)
            {
                string s = "select * from item where itemID = '" + txtidsp.Text + "' ";
            ...
            {
                //Update
                string s = "update item set itemName = '" + txttensp.Text + "', size = '" + txtslsp.Text + "', quantity = '" + txtgiasp.Text + "' where itemID = '" + txtidsp.Text + "'";
                cm = new SqlCommand(s, cn);
                cm.ExecuteNonQuery();
            }
            formload();
        ...
        private void grd3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtagent.Text = grd3.CurrentRow.Cells[3].Value.ToString();
